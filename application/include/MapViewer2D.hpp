#ifndef MAPVIEWER2D_HPP
#define MAPVIEWER2D_HPP
...
class MapViewer2D : public Object2D
{
public:
  MapViewer2D(); // Default
  MapViewer2D(const float x_bottom, const float y_left, const float width, const float height, const std::string pathTexture); 
  ~MapViewer2D();
