...
Kart::Kart()
  : BOUNDING_BOX_SIZE(glm::vec3(1.0, 2.f, 2.1f)), position(0.f, 0.f, 0.f), boundingBox(position, BOUNDING_BOX_SIZE), orientation(glm::angleAxis(0.f, glm::vec3(0.f, 1.f, 0.f))),
...
Kart::Kart(std::string kartName)
    : BOUNDING_BOX_SIZE(glm::vec3(1.0, 2.f, 2.1f)), position(1.9f, 0.f, 6.f), boundingBox(position, BOUNDING_BOX_SIZE), orientation(glm::angleAxis(0.f, glm::vec3(0.f, 1.f, 0.f))),
