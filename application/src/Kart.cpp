...
Kart::Kart()
  : BOUNDING_BOX_SIZE(glm::vec3(1.f)), position(0.f, 0.f, 0.f), boundingBox(position, glm::vec3(1.f)), orientation(glm::angleAxis(0.f, glm::vec3(0.f, 1.f, 0.f))),
...
Kart::Kart(std::string kartName)
  : BOUNDING_BOX_SIZE(glm::vec3(1.f)), position(1.9f, 0.f, 6.f), boundingBox(position, glm::vec3(1.f)), orientation(glm::angleAxis(0.f, glm::vec3(0.f, 1.f, 0.f))),
