...
void GraphicEngine::renderFrame()
{
  ...
  //Gestion de la lumiËre
  if (currentLight != nullptr)
  {

  }

  //En attendant une meilleure gestion de la cam√©ra dans le menu,
  //menu => camera == nullptr
...
void GraphicEngine::initShaderPrograms()
{
  ...
  //uniform correspondant aux lumiËres
...
{
  //Utiliser un iterator d√©clenche un bug hyper chelou (tente de d√©truire un deuxi√®me
  //pointeur vers la classe m√®re...)
